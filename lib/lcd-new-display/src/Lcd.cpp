...
void Lcd::menu_display(int cursor, bool dbl_in = false, bool dbl_out = false, int players = 2){
  ...
  ucg.setFontMode(UCG_FONT_MODE_SOLID);
  ucg.setPrintPos(0, 15);
  if(cursor == POINTS && selected_pos){
  ucg.setColor(0, 0, 0, 0);       // black color for the text
  ucg.setColor(1, 255,255,0); // yellow for the background
  }else if(cursor == POINTS){
    ucg.setColor(0, 0, 0, 0);       // black color for the text
  ...
  if(cursor == PLAYERS && selected_pos){
  ucg.setColor(0, 0, 0, 0);       // black color for the text
  ucg.setColor(1, 255,255,0); // yellow for the background
  }else if(cursor == PLAYERS){
    ucg.setColor(0, 0, 0, 0);       // black color for the text
    ucg.setColor(1, 150, 220, 255); // light blue for the background
  }else {
    ucg.setColor(0, 255, 255, 255);      
  ...
  if(cursor == DOUBLEIN && selected_pos){
  ucg.setColor(0, 0, 0, 0);       // black color for the text
  ucg.setColor(1, 255,255,0); // yellow for the background
  }else if(cursor == DOUBLEIN){
    ucg.setColor(0, 0, 0, 0);       // black color for the text
    ucg.setColor(1, 150, 220, 255); // light blue for the background
  }else {
    ucg.setColor(0, 255, 255, 255);       
  ...
  if(cursor == DOUBLEOUT && selected_pos){
  ucg.setColor(0, 0, 0, 0);       // black color for the text
  ucg.setColor(1, 255,255,0); // yellow for the background
  }else if(cursor == DOUBLEOUT){
    ucg.setColor(0, 0, 0, 0);       // black color for the text
    ucg.setColor(1, 150, 220, 255); // light blue for the background
  }else {
    ucg.setColor(0, 255, 255, 255);       
...
void Lcd::score_display(std::string nickname, int score, int attempts){
